            ...
            <div class="new-registration-wrapper">
                ...
                <form method="" action="" id="cio_data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="number_of_nominator" class="form-control" id="number_of_nominator" placeholder="Contact number of Nominator" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-6">
                    ...
                    <p class="title-color"><strong>4. Transform Security</strong></p>
                    <div class="dt-wrapper">
